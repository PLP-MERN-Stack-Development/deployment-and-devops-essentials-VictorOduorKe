...
*   `LIVE_MONGODB_URI`: Your MongoDB connection string. For local MongoDB, it's typically `mongodb://localhost:27017/mern_blog_db`. For MongoDB Atlas, use your connection string.
